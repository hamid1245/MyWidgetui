...
import 'bottomNavigationFourth.dart';

class BottomNavigationThird extends StatelessWidget {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              onPressed: () { NavigationHelper.pushRoute(context, BottomNavigationFourth());},
              icon: Icon(
                Icons.search,
                color: AppConstants.scaffoldBackgroundColor,
              ),
